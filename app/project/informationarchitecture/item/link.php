...
if (isset($_params['CONFIRMED'])) {
    ...
    if ($targetItem['flag'] == 'container' || $targetItem['flag'] == 'image' ||$targetItemDetails['flag'] == 'link') {
        $_app->flash('danger', 'Container, Grafiken oder Links können nicht verlinkt werden.');
